...
export function InstallPrompt() {
  ...
  if (!installPrompt || isDismissed || isStandalone || isPwaFloatingPromptSuppressedRoute(pathname)) {
    return null;
  }

  return (
    <>
      <aside className="fixed inset-x-3 bottom-[calc(11rem+env(safe-area-inset-bottom))] z-[45] mx-auto max-w-md md:inset-x-auto md:right-6 md:bottom-6 md:w-96">
